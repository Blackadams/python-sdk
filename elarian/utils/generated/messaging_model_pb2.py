...
_MESSAGINGCONSENTUPDATE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='MESSAGING_CONSENT_UPDATE_OPT_IN', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='MESSAGING_CONSENT_UPDATE_OPT_OUT', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_INBOUNDMESSAGEBODY.fields_by_name['ussd'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
